<template>
    <section class="bg-white py-8" id="Best-Sellers">
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img
                        class="hover:grow hover:shadow-lg"
                        src="/img/sutterlin-1362879_1280.jpg"
                    />
                    <div class="pt-3 flex items-center justify-between">
                        <p class="text-sm truncate">
                            "Mystery: The Mystery of the Forgotten Journal"
                        </p>
                        <svg
                            class="h-6 w-6 fill-current text-gray-500 hover:text-black"
                            xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img
                        class="hover:grow hover:shadow-lg"
                        src="/img/vintage-pocket-watch-7439236_1280.jpg"
                    />
                    <div class="pt-3 flex items-center justify-between">
                        <p class="text-sm truncate">
                            "Wonderlust: Adventures Around the Globe"
                        </p>
                        <svg
                            class="h-6 w-6 fill-current text-gray-500 hover:text-black"
                            xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img
                        class="hover:grow hover:shadow-lg"
                        src="/img/night-4028339_1280.jpg"
                    />
                    <div class="pt-3 flex items-center justify-between">
                        <p class="text-sm truncate">
                    ...
                    <p class="pt-1 text-gray-900 text-sm">Isabella Graves</p>
                    <strike
                        ><p class="pt-1 text-gray-900 text-sm">
                            $25.00
                        </p></strike
